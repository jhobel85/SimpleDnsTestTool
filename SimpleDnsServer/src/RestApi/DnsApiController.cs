...
namespace SimpleDnsServer.RestApi
{
    [ApiController]
    [Route("dns")]
    public class DnsApiController(DnsRecordManger recordManger) : ControllerBase
    {
        private readonly DnsRecordManger recordManger = recordManger;
        ...
        public IActionResult Resolve(string domain)
        {
            ...
            return (IActionResult)Ok((object)str);
        }

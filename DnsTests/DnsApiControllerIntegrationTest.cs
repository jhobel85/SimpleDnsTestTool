...
{
    public class DnsApiControllerIntegrationTest : IClassFixture<WebApplicationFactory<DualstackDnsServer.TestProgram>>
    {
        private readonly HttpClient _client;

        public DnsApiControllerIntegrationTest(WebApplicationFactory<DualstackDnsServer.TestProgram> factory)
        {
